...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLegalDataJavaScriptApi.TokenAuthApi();
  });
  ...
  describe('TokenAuthApi', function() {
    describe('tokenAuthCreate', function() {
      it('should call tokenAuthCreate successfully', function(done) {
        //uncomment below and update the code to test tokenAuthCreate
        //instance.tokenAuthCreate(function(error) {
