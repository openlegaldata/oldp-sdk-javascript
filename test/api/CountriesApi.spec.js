...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLegalDataJavaScriptApi.CountriesApi();
  });
  ...
  describe('CountriesApi', function() {
    ...
    describe('countriesRead', function() {
      it('should call countriesRead successfully', function(done) {
        //uncomment below and update the code to test countriesRead
        //instance.countriesRead(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
