...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLegalDataJavaScriptApi.CaseMarker();
  });
  ...
  describe('CaseMarker', function() {
    it('should create an instance of CaseMarker', function() {
      // uncomment below and update the code to test CaseMarker
      //var instance = new OpenLegalDataJavaScriptApi.CaseMarker();
      //expect(instance).to.be.a(OpenLegalDataJavaScriptApi.CaseMarker);
    });
