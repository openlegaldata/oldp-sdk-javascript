...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLegalDataJavaScriptApi.CourtMinimal();
  });
  ...
  describe('CourtMinimal', function() {
    it('should create an instance of CourtMinimal', function() {
      // uncomment below and update the code to test CourtMinimal
      //var instance = new OpenLegalDataJavaScriptApi.CourtMinimal();
      //expect(instance).to.be.a(OpenLegalDataJavaScriptApi.CourtMinimal);
    });
