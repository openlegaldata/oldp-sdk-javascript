...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenLegalDataJavaScriptApi.State();
  });
  ...
  describe('State', function() {
    it('should create an instance of State', function() {
      ...
      //var instance = new OpenLegalDataJavaScriptApi.State();
      //expect(instance).to.be.a(OpenLegalDataJavaScriptApi.State);
    });
