...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OldpApi.InlineResponse20011 = factory(root.OldpApi.ApiClient, root.OldpApi.State);
  }
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/State>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [State]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/State>} results
   */
