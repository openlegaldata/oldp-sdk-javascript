...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LawSearch'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LawSearch'));
  } else {
    // Browser globals (root is window)
    if (!root.OldpApi) {
      root.OldpApi = {};
    }
    root.OldpApi.InlineResponse20010 = factory(root.OldpApi.ApiClient, root.OldpApi.LawSearch);
  }
}(this, function(ApiClient, LawSearch) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/LawSearch>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [LawSearch]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/LawSearch>} results
   */
