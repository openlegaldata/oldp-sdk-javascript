...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LawBook'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LawBook'));
  } else {
    // Browser globals (root is window)
    if (!root.OldpApi) {
      root.OldpApi = {};
    }
    root.OldpApi.InlineResponse2008 = factory(root.OldpApi.ApiClient, root.OldpApi.LawBook);
  }
}(this, function(ApiClient, LawBook) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/LawBook>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [LawBook]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/LawBook>} results
   */
