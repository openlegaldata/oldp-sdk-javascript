...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OldpApi.InlineResponse2006 = factory(root.OldpApi.ApiClient, root.OldpApi.Country);
  }
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/Country>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Country]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Country>} results
   */
