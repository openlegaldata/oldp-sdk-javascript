...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OldpApi.CaseAnnotation = factory(root.OldpApi.ApiClient);
  }
  ...
  /**
   * The CaseAnnotation model module.
   * @module model/CaseAnnotation
   * @version v1
   */

  /**
   * Constructs a new <code>CaseAnnotation</code>.
   * @alias module:model/CaseAnnotation
   * @class
  ...
  /**
   * Constructs a <code>CaseAnnotation</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CaseAnnotation} obj Optional instance to populate.
   * @return {module:model/CaseAnnotation} The populated <code>CaseAnnotation</code> instance.
   */
