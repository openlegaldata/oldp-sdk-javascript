...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Court'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Court'));
  } else {
    // Browser globals (root is window)
    if (!root.OldpApi) {
      root.OldpApi = {};
    }
    root.OldpApi.InlineResponse2007 = factory(root.OldpApi.ApiClient, root.OldpApi.Court);
  }
}(this, function(ApiClient, Court) {
  'use strict';
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/Court>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [Court]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Court>} results
   */
