...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OldpApi.InlineResponse2005 = factory(root.OldpApi.ApiClient, root.OldpApi.City);
  }
   ...
   * @class
   * @param count {Number} 
   * @param results {Array.<module:model/City>} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('results')) {
        obj['results'] = ApiClient.convertToType(data['results'], [City]);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/City>} results
   */
